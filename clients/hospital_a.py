...
from utils.metrics_logger import logger  # ADD THIS
...
class HospitalClient(fl.client.NumPyClient):
    def __init__(self, client_id, train_loader, val_loader, round_num=0):
        ...
        print(f"✅ Hospital {client_id}: {len(train_loader.dataset)} training samples")
    ...
    def evaluate(self, parameters, config):
        ...
        print(f"📊 Hospital {self.client_id} - Val Acc: {accuracy:.2f}%")
...
if __name__ == "__main__":
    ...
    client = HospitalClient("A", hospital_loaders[0], val_loader)
